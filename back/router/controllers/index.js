...
const { editProfile, getProfile, sendCom, replyCom, deleteCom, likeCom, reportCom} = require("./UserController");
...
module.exports = {
    ...
    // User
    editProfile, getProfile, sendCom, replyCom, deleteCom, likeCom, reportCom
}